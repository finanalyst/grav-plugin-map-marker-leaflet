        ...
        $this->shortcode->getHandlers()->add('map-leaflet', function (ShortcodeInterface $sc) {
            ...
            switch ($config['provider']) {
                ...
                case 'wikimedia':
                    ...
                    $attribution = '© <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors & <a href="https://wikimedia.org">Wikimedia</a>';
                    $maxzoom = 24;
                    $apikey = '';
                    $opts = [];
                    if (!$style || !in_array($style, $opts)) {
